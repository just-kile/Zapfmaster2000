...
public class TestFrontpageUserStats extends AbstractMockingTest {
	...
	public void testSimple() {
		FrontpageStatsResource resource = new FrontpageStatsResource();

		Response response = resource.retrieveFrontpageStats(null, null);
	...
	public void testBadInput() {
		...
		Response response = resource.retrieveFrontpageStats(null, "noInteger");
	...
	public void TestFullInput() {
		...
		Response response = resource.retrieveFrontpageStats(null, "5");
