...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Challenge1v1 Done News</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link de.kile.zapfmaster2000.rest.model.zapfmaster2000.impl.Challenge1v1DoneNewsImpl#getChallenge <em>Challenge</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Challenge1v1DoneNewsImpl extends NewsImpl implements Challenge1v1DoneNews {
	/**
	 ...
	 * @generated
	 */
	protected Challenge1v1DoneNewsImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return Zapfmaster2000Package.Literals.CHALLENGE1V1_DONE_NEWS;
	}
		...
		if (challenge != null && challenge.eIsProxy()) {
			...
			if (challenge != oldChallenge) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Zapfmaster2000Package.CHALLENGE1V1_DONE_NEWS__CHALLENGE, oldChallenge, challenge));
			}
		}
		return challenge;
	}
	...
	public void setChallenge(Challenge1v1 newChallenge) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Zapfmaster2000Package.CHALLENGE1V1_DONE_NEWS__CHALLENGE, oldChallenge, challenge));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Zapfmaster2000Package.CHALLENGE1V1_DONE_NEWS__CHALLENGE:
