...
public class TestChallengeService extends AbstractDatabaseTest {
	...
	public void createEntities() {
		...
		user1 = createUser("u1", "", "", 0, Sex.MALE, 0, UserType.USER, account1);
		user2 = createUser("u2", "", "", 0, Sex.MALE, 0, UserType.USER, account1);
		user3 = createUser("u3", "", "", 0, Sex.MALE, 0, UserType.USER, account2);
	}
