...
public class LocalNotification extends Plugin {
	...
	alarm = new AlarmHelper((Context) this.ctx);
	 ...
	 * by one.
	 */
	final SharedPreferences alarmSettings = ((Context) this.ctx).getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE);
	...
	final Editor alarmSettingsEditor = ((Context) this.ctx).getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE).edit();
