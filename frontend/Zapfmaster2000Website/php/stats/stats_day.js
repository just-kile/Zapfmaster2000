...
INTERVALL_NUMBERS = 48;
new Ajax.Request('getStats.php',{
			method:'get',
			parameters:{"bestlist":"",'kegamount': "",'best':"",'keg':"",'niceword':"",'drinkspeed':"",'duration':"",'progressweek':"","promille":"","mostachievements":"","drinkstats":"","day":""},
	...
	Ext.create('Ext.chart.Chart',{
                ...
                fields: ['time'],
				  label: {
                    renderer: function(sprite, record, attributes, index, store){
					  ...
					  var timeZone = time>23? time-24 : time;
            ...
            series: [{
                ...
                tips: {
                  ...
                  height: 28,
                  renderer: function(storeItem, item) {
					  var time = storeItem.get('time')/2 +8;
					  //var timeFloor =  Math.floor(time)
					  var timeZone = time>23? time-24 : time;
                   	  this.setTitle( timeZone+" Uhr: "+Math.round(storeItem.get('amount')*100)/100 + ' Liter ');
                  }
                },
               /* label: {
                  display: 'insideEnd',
...
function refreshCharts(day){
	var params;
	if(typeof day == "undefined" || day==null){
		params = {"bestlist":"",'kegamount': "",'best':"",'keg':"",'niceword':"",'drinkspeed':"",'duration':"",'progressweek':"","promille":"","mostachievements":"","drinkstats":"","day":""};
		
	}else{
		params ={"bestlist":"",'kegamount': "",'best':"",'keg':"",'niceword':"",'drinkspeed':"",'duration':"",'progressweek':"","promille":"","mostachievements":"","drinkstats":"","day":day};
...
window.generateDataLine = function(json){
        ...
        var data = [];
		 ...
		 k=0;
        for(var i = 0;i<2 ;i++){//progressweek.length
			var test  =(progressweek[i]==undefined) ? new Array():progressweek[i];
        	var tempIntervallNumbers = INTERVALL_NUMBERS;
			//tempIntervallNumbers =INTERVALL_NUMBERS-24/48 *8 ;
			for(var j = 0;j<tempIntervallNumbers;j++){
				
				var time = (j)/(tempIntervallNumbers);
				var amount=0 ;
				if(test[j] == undefined){
